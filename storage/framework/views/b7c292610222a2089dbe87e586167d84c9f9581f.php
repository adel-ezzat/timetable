...
<script>
    ...
    function generateTable() {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo e(route('timetable.generate-dates-range')); ?>',
            headers: {
    ...
    $('#submit').click(function (event) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo e(route('timetable.store')); ?>",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/a/Desktop/timetable/resources/views/dashboard/timetable/index.blade.php ENDPATH**/ ?>