...
<div class="col-12 grid-margin stretch-card">
    ...
    <div class="card">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Add Roles And Permissions')): ?>
        <div class="card-header">
            <div class="d-flex align-items-center">
                <h3 class="mr-auto p-3"></h3>
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('role.create')); ?>" class="btn btn-primary" role="button"><i
                            class="mdi mdi mdi-plus-circle btn-icon-prepend"></i>Add Role</a>
                </div>
            </div>
        </div>
        <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check form-check-muted m-0">
                                            <label class="form-check-label">
                                                <input type="checkbox" id="<?php echo e($role->id); ?>" class="form-check-input">
                                            </label>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($role->id != 1): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Roles And Permissions')): ?>
                                        <a href="<?php echo e(route('role.edit', $role->id)); ?>" class="btn btn-outline-primary"
                                            role="button">Edit</a>
                                        <?php endif; ?>

                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Roles And Permissions')): ?>
                                        <a href="#" class="btn btn-outline-danger"
                                        onclick="deleteButton( <?php echo e($role->id); ?> )" role="button">Delete</a>
                                        <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<script>
    ...
    function deleteSelected(id) {
        swalConfirm(function () {
            var ids = getSelected();
            request('post', '<?php echo e(route('role.destroy-ajax')); ?>', ids);
            deleteRowSelected();
        })
    }
    ...
    function deleteButton(id) {
        swalConfirm(function () {
            var ids = getSelected();
            request('post', '<?php echo e(route('role.destroy-ajax')); ?>', {id});
            removeRowButton(id);
        })
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/a/Desktop/timetable/resources/views/dashboard/role/index.blade.php ENDPATH**/ ?>