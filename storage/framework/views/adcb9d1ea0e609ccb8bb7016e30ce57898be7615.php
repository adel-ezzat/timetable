...
<div class="col-12 grid-margin stretch-card">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Add Pharmacies')): ?>
        <div class="card-header">
        <div class="d-flex align-items-center">
            <h3 class="mr-auto p-3"></h3>
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('pharmacy.create')); ?>" class="btn btn-primary" role="button"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check form-check-muted m-0">
                                            <label class="form-check-label">
                                                <input type="checkbox" id="<?php echo e($pharmacy->id); ?>" class="form-check-input">
                                            </label>
                                        </div>
                                    </td>
                                    <td><?php echo e($pharmacy->name); ?></td>
                                    <td>
                                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Pharmacies')): ?>
                                       <a href="<?php echo e(route('pharmacy.edit', $pharmacy->id)); ?>" class="btn btn-outline-primary"
                                        role="button">Edit</a>
                                       <?php endif; ?>
                                    
                                       <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Pharmacies')): ?> 
                                        <a href="#" class="btn btn-outline-danger" onclick="deleteButton( <?php echo e($pharmacy->id); ?> )" role="button">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/a/Desktop/timetable/resources/views/dashboard/pharmacy/index.blade.php ENDPATH**/ ?>