...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="<?php echo e(route('admin.update-ajax')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name"
                        value="<?php echo e(old('name', $admin->name)); ?>" required autocomplete="name" autofocus>
...
unset($__errorArgs, $__bag); ?>"
                        name="email" value="<?php echo e(old('email', $admin->email)); ?>" autocomplete="email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/a/Desktop/timetable/resources/views/dashboard/admin/edit.blade.php ENDPATH**/ ?>