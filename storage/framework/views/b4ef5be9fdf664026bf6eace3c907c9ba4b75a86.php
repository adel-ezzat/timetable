        ...
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary" role="button"><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check form-check-muted m-0">
                                            <label class="form-check-label">
                                                <input type="checkbox" id="<?php echo e($user->id); ?>" class="form-check-input">
                                            </label>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="btn btn-outline-primary"
                                            role="button">Edit</a>
                                        <?php endif; ?>
                                        
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Users')): ?>
                                        <a href="#" class="btn btn-outline-danger" onclick="deleteButton( <?php echo e($user->id); ?> )" role="button">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<script>
    ...
    function deleteSelected(id) {
        swalConfirm(function() {
            var ids = getSelected();
                 request('post', '<?php echo e(route('user.destroy-ajax')); ?>', ids);
                 deleteRowSelected();
        })
    }
      ...
      function deleteButton(id) {
        swalConfirm(function() {
            var ids = getSelected();
                 request('post', '<?php echo e(route('user.destroy-ajax')); ?>', {id});
                 removeRowButton(id);
        })
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/a/Desktop/timetable/resources/views/dashboard/user/index.blade.php ENDPATH**/ ?>